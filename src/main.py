...
config = template.render(hostname=hostname , zones= networks,access_ports= access_ports ,trunk_interfaces=trunk_interfaces,allowed_vlans =allowed_vlans,firewall_ip=firewall_ip ) 
print("\n======GENERATED CONFIG =========") 
print(config)
#===============parametre du device==============
